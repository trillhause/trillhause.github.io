...
angular.module('Portfolio').controller('WorkController', ['$sce', '$http', function ($sce, $http) {
  ...
  this.projects = [
    {
      title: "deeps",
      content: $sce.trustAsHtml("deeps solves the 2017 intern challenge posted by <a href='https://twitter.com/comma_ai/status/849131721572327424?lang=en' target='_blank'>Comma.ai</a>. t uses optical flow analysis and convolutional neural networks to estimate the speed of a car from dashcam footage. Training computers through a video input is essential for autonomous industry. LIDARs are great localizing and mapping but they are expensive and drive up the cost of a car significantly. Consumer facing industry thus have to rely on cameras and sensors to make the vehicle autonomous. <br><br> deeps uses OpenCV  for video processing and optical flow analysis. It implements an end to end architecture based on <a href='https://arxiv.org/pdf/1604.07316v1.pdf' target='_blank'>Nvidia’s paper</a> for training. Check out the <a href='https://github.com/millingab/deeps/blob/master/Full%20Article.md' target=\"_blank\">full article</a> to learn more about the data processing and training parameters used in deeps.<br><br><em>deeps performed exceptionally better than the 99% of the other models. Final mean square error on test data was 3.48</em><br><br> <a href='https://github.com/millingab/deeps' target=\"_blank\">Learn More</a> <br>"),
      current: 0,
      images: [
        {
          id: 0,
